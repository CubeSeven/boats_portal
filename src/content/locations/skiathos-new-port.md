...
heroGradient: "ocean"
status: "Ferry Terminal Hub"
icon: "ship"
directions: "Located directly at the New Port ferry terminal, look for our kiosk by the passenger exit. Minutes from the airport."
latitude: 39.1652
longitude: 23.4931
mapZoom: 15
services:
  - icon: "ship"
    title: "Boat Rentals"
    description: "Step off the ferry and straight onto your own boat."
    href: "/boat-rental/"
    price: "From €80"
  - icon: "taxi"
    title: "Water Taxi"
...
- **Ferry-Side Access:** The closest base to all commercial ferry arrivals.
- **Airport Proximity:** Just a short transfer from the airport terminal.
- **Instant Departures:** No need to travel into town — start your maritime adventure right away.
